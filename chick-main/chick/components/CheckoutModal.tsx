        ...
        return (
          <div className="text-center py-20 space-y-10 animate-scale-up">
            ...
            <div className="bg-slate-50/50 p-6 rounded-[3rem] border-2 border-slate-100 space-y-4">
              ...
              <div className="bg-green-50 p-4 rounded-2xl border border-green-100 flex items-center gap-3 animate-reveal">
                <div className="bg-green-500 p-2 rounded-lg text-white">
                  <CheckCircle size={16} />
                </div>
                <p className="text-[10px] font-bold text-green-700 text-left">
                  {isAr 
                    ? 'تم فتح واتساب لإرسال تفاصيل الطلب للمطعم. تأكد من الضغط على "إرسال" في واتساب.' 
                    : 'WhatsApp opened to send order details. Make sure to press "Send" in WhatsApp.'}
                </p>
              </div>
